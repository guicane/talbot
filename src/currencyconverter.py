""""
Currency Converter
A simple currency converter that uses the exchangerate.host API to get exchange rates.
"""
...
async def handle_convert_command(update, context):
    """
    ...
    try:
        ...
        # Perform conversion in a non-blocking thread
        result = await asyncio.to_thread(converter.convert, amount, from_currency, to_currency)
